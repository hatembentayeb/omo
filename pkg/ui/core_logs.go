...
func (c *CoreView) ShowLogs(title, body string, onRefresh func() (string, error)) {
	...
	v.titleBar.SetBackgroundColor(ColorAppBg)
	...
	v.controlsBar.SetBackgroundColor(ColorAppBg)
	...
	v.metaBar.SetBackgroundColor(ColorAppBg)
	...
	v.searchInput.SetFieldBackgroundColor(ColorAppBg)
